    ...
    <div class="container mt-4">
      <div class="card border-0 overflow-hidden shadow rounded-20 mb-5" style="border-radius:20px">
          ...
          <div class="card-body my-3">
            <h1>Create New Score Type</h1>
              <form action="{{route('score-types.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="form-group mb-3">
                    <label class="col-form-label" for="type_name">Type<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="type_name" id="type_name" placeholder="Enter Type" value="{{old('type_name')}}">
                  </div>
                  <div class="row my-4">
                    <div class="col">
