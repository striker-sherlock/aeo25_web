<x-layout>
            ...
            <div class="row   justify-content-center align-items-center w-100 mx-auto ">
                ...
                <div class="col-md-8 my-3 px-4  ">
                    ...
                    <p class="text-muted mt-4 text-justify">
                        ...
                        life before the pandemic. Despite the changes currently happening in our mother earth, without
                        any doubt, youngsters like us are capable of adapting to changes that press us and being able to
                        grow as well as explore ourselves to spark and eventually become the best version of ourselves.
                    </p>
                    <p class="text-muted mt-4 text-justify">
                        Asian English Olympics is a learning platform for Asian Youths to learn new things, show their
                        talents, and build networks with many participants across Asia. Hence, this year’s AEO shall be
                        their milestone to seek for their greatest potential within themselves. From a little spark, you
                        can make yourself sparkle and shine even in the darkest night. As the Project Manager of The
                        2023 Asian English Olympics, I believe that Asian Youths can unveil their hidden spark and shine
                        brightly in the middle of alteration.
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- End Previous AEO Section Section -->
