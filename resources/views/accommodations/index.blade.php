<x-admin>
  {{-- {{dd($accommodations[0]->facilities->sortByDesc('is_available'))}} --}}
  <div class="container mt-4">
    <x-card>
      <h3 class="text-uppercase fw-bold display-6 text-gradient mb-4" style="letter-spacing: 0.1em">Accommodation List</h3>
