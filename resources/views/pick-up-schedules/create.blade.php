    ...
    <div class="container mt-4">
        <x-card>
            ...
            <form action="{{route('pick-up-schedules.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mb-3">
                    <label for="schedule" class="col-form-label">Schedule Time<span class="text-danger">*</span></label>
                <input type="datetime-local" class="form-control" id="schedule" placeholder="Enter Flight Time" name="schedule" required value="{{old('schedule')}}" min="2023-02-10T00:00:00">
                </div>
                <div class="row">
                    <div class="col">
