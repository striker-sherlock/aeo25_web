<x-layout>
    ...
    <body>
        ...
        <main id="main">
            ...
            <div id="why-join">
                <div class="container text-center wow fadeInUp">
                    ...
                    <h2 class="fw-bold mt-3 display-5" style="color:#ff99c7; font-family:lexend;">We are continuously
            ...
            <section class='competition-fields' id='competition-fields'>
                <div class="container text-center my-3">
                    ...
                    <h1 class="mt-3 fw-bold position-relative d-inline-block  ">COMPETITION FIELDS
                        ...
                        <span
                            class="d-flex justify-content-center align-items-center fs-6 position-absolute rounded-circle  fw-bold"
                            title="see details" data-bs-toggle="modal" data-bs-target="#general-detail">!</span>
                    </h1>
            ...
            <section class="how-to-regist" id="howToRegister">
                <div class="container">
                    ...
                    <img src="/storage/assets/step-regist.webp" loading="lazy" class="img-fluid rounded-20 shadow-sm"
                        alt="step-by-step">
                                ...
                                <div class="row">
                                    <div class="slider card rounded-20  p-3 col-10">
                                        ...
                                        <div class="slide active">
                                            ...
                                            <div class="right">
                                                <sup>
                                                    <i class="fa-solid fa-quote-left fa-2x me-2"
                                                        style="color: #80679E"></i>
                                                </sup>
                                                <p class="text-justify fs-6">{{ $ambassador->testimony }} <i
                                                        class="fa-solid fa-quote-right fa-2x ms-2"
                                                        style="color: #80679E"></i></p>
                                                <div class="client-info">
                                                    <small>
                                                        <p class="mb-0 fw-bold">{{ $ambassador->name }},</p>
                                                        <p class="text-muted mb-0">{{ $ambassador->institution }}
                                                        </p>
                                                    </small>
                                                </div>
                                            </div>
                    ...
                    <div class="container text-center mt-5 wow fadeInUp">
                        <div class="container text-center mt-5 wow fadeInUp" data-aos="fade-up">
                            <header class="section-header">
                                ...
                                <h1 class="mt-3 fw-bold text-center mb-3 text-gradient text-uppercase">Frequently Asked
                                    Questions</h1>
                            </header>
                                    ...
                                    @foreach ($faqs as $faq)
                                        <div class="col-lg-6 col-md-6">
                                            <div class="card border-0 card-shadow card-faq my-3 text-light">
                                                <a id="accordionItem"
                                                    class="btn collapsed accordion-button card-accordion text-start text-primary text-light mh-50"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#faqAccordion{{ $faq->id }}"
                                                    aria-expanded="false"
        ...
        <div class="modal modal-lg fade" id="general-detail" tabindex="-1" aria-labelledby="modal-title"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-20 border-0 shadow p-4">
                    <div class="modal-headers border-bottom-0 p-3 ">
                        <h1 class="text-uppercase fw-bold  text-center text-gradient " style="letter-spacing: 0.1em">
                            General Rules </h1>
                        <div class="d-flex justify-content-center">
                        ...
                        <p>
                            There will be 7 different fields of competition, which are Speech, Newscasting,
                            Storytelling, Debate, Spelling Bee, and Online Competition. All the fields of competition in
                            the 2023 AEO will have general rules that will be implemented in many kinds of the
                            competition fields. Hereby are the important general rules that have to be noticed by the
                            participants of the competition fields.
                    ...
                    <div class="modal-body" style="margin-top:-20px;">
                        ...
                        <ul class="list-group" style="">
                            <li class="list-group-item">Past champions of the Asian English Olympics are not allowed to
                                join the same competition field that they have won before. But they are allowed to join
                                other competition fields.
                            </li>
                            <li class="list-group-item">Participants must re-register themselves before the technical
                                meeting or opening ceremony to get their name tags and confirm their attendance.

                            </li>
                            <li class="list-group-item">Participants must come at least an hour before the Opening
                                Ceremony, Breaking Announcement, Closing Ceremony and the competition rounds.

                            </li>
                            <li class="list-group-item">Participants are highly recommended to attend the coaching
                                clinic to learn some tips and tricks from our judges regarding the rounds.

                            </li>
                            <li class="list-group-item"> Participants who don’t attend the technical meeting and
                                coaching clinic won’t be guaranteed to get further information from the committee
                                outside of those sessions.

                            </li>

                            <li class="list-group-item"> All participants must arrive at the waiting room at least 15
                                minutes before the competition starts.
                            </li>

                            <li class="list-group-item"> There will be a roll call before every round. All participants
                                will be called 3 times when it’s their turn, before considered as a walk-out.

                            </li>
                            <li class="list-group-item">Participants should remain outside the performing room that is
                                designated by the committee until they are called to perform.

                            </li>
                            <li class="list-group-item"> Judges may (in their discretion) deduct 3 points from the
                                total score in one round for violation of rules (deduction for exceeding timing will be
                                described in timing rules).

                            </li>
                            <li class="list-group-item"> 3 points will be deducted for each of violations, such as
                                discriminating/insulting explicitly or implicitly any ethnicity, nation, and religion.

                            </li>
                            <li class="list-group-item"> 3 points will be deducted for explicit content as well like
                                pornography (for example mentioning about two people having an intercourse or describing
                                some sensitive body part exaggeratedly)

                            </li>
                            <li class="list-group-item"> Judges may also disqualify participants for gross misconduct
                                or ineligibility.

                            </li>
                            <li class="list-group-item"> Properties categorized as sharp tools or dangerous weapons,
                                liquids, or powders that can litter the performing room are strictly prohibited.

                            </li>

                            <li class="list-group-item">Participants are encouraged to bring their own stationery.
                            </li>
                            <li class="list-group-item">All judges’ decisions and results inside the result slips and
                                ballots are considered final.
                            </li>
                            <li class="list-group-item">Participants are prohibited from bringing any script/notes
                                during their performance on stage (except debate, speech in preliminary II,
                                newscasting).
                            </li>
                            <li class="list-group-item">Participants are prohibited from being assisted by anyone else
                                (friends, teachers, coaches, PICs, etc), except fellow teammates in Debate Competition.
                            </li>
                            <li class="list-group-item">Participants that perform any form of cheating will be
                                disqualified.
                            </li>
                            <li class="list-group-item">Every payment done by the participant can’t be undone (no
                                refund).
                            </li>
                            <li class="list-group-item">No electronic devices allowed during competition(Preparation
                                room, performing room, after performing room).
                            </li>
                            <li class="list-group-item">The rules of the competition might change, if the changes did
                                happen, the committee will provide notifications of the rules change in the AEO Website.
                            </li>
                        </ul>

                    </div>
                    <div class="modal-footers text-center">
                        <button type="button" class="btn btn-outline-theme rounded-pill rounded-20 mb-4 px-4"
                            data-bs-dismiss="modal">
                            OK, I got it
                        </button>
                    </div>
