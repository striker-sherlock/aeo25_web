      ...
      <div class="card border-0 overflow-hidden shadow rounded-20 mb-5" style="border-radius:20px">
          ...
          <div class="card-body my-3">
            <h1>Create Accomodation</h1>
              <form action="{{route('accomodations.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="max_guests" id="max_guests" placeholder="Enter Number of Guests" value="{{old('max_guests')}}">
                  </div>
